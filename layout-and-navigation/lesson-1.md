...
* **c**. Cut the whole header div (`<div data-role="header">`) from the 'index' and replace with it the `data-role="header"` in the layout you just created. Your layout should now look like this:
```
